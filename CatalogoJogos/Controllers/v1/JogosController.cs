...
namespace CatalogoJogos.Controllers.v1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        public JogosController(IJogoServices jogoService)
        {
        ...
        public async Task<ActionResult<JogoViewModel>> InserirJogo([FromBody] JogoInputModel jogoInputModel)
        {
            ...
            {
                return UnprocessableEntity("Já exisatee um jogo com este nome para esta produtora");
            }
        }
        ...
        [HttpPost("{idJogo:guid}/preco/{preco:double}")]
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromRoute] double preco)
        {
            ...
            catch(JogoNaoCadastradoExcepition ex)
            {
                return NotFound("Não existe este jogo");
            }
